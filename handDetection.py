...
def run(model: str, num_hands: int,
        ...
        proc_width: int, proc_height: int) -> None:
    """Continuously run inference on images acquired from the stream URL."""
...
def main():
    ...
    parser.add_argument('--streamUrl', required=False, default="http://nitsuga:putoelquelee@192.168.0.127:30141/videostream.cgi", help='URL of the video stream.')
    ...
    run(args.model, args.numHands, args.minHandDetectionConfidence, args.minHandPresenceConfidence,
        ...
        args.procWidth, args.procHeight)
